...
typealias CognitiveServicesTagsResult = ([String]?, NSError?) -> (Void)

/// Fill in your API key here after getting it from https://www.microsoft.com/cognitive-services/en-US/subscriptions
let CognitiveServicesComputerVisionAPIKey = "b232ea13794a40a68c4325a0953cc3de"
...
class CognitiveServicesManager: NSObject {
     ...
     */
    func retrievePlausibleTagsForImage(_ image: UIImage, completion: @escaping CognitiveServicesTagsResult) {
        print("calling")
                    ...
                    if let dictionary = collectionObject as? Dictionary<String, AnyObject> {
                        ...
                        if let typedTags = tags as? Array<Dictionary<String, AnyObject>> {
                            for tag in typedTags {
                                ...
                                if confidence > CognitiveServicesConfiguration.RequiredConfidence {
